          ...
          <div className="w-full max-w-md space-y-10 relative z-10 ">
            ...
            <div className="glass-panel p-4 md:p-4 shadow-2xl border rounded-3xl border-tawny-800">
              ...
              <div className="mt-8 flex justify-center mb-4">
                <button className="flex items-center justify-center gap-3 py-4 px-6 glass-panel rounded-lg transition-all duration-500 border border-amber-500 hover:scale-[1.02]">
