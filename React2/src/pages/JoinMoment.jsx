...
const JoinMoment = () => {
    ...
    useEffect(() => {
        const fetchMomentDetails = async () => {
            ...
            try {
                const res = await axios.get(`https://moment-sandy.vercel.app/api/v1/moments/shared/${slug}`);
    ...
    const handleJoin = async () => {
        ...
        try {
            ...
            await axios.post(`https://moment-sandy.vercel.app/api/v1/moments/${slug}/join`, {}, {
